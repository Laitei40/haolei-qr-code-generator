const I18N = (() => {
  ...
  const embedded = {
    ...
    my: {
      ...
      "privacy.overview.body": "Haolei QR ကုဒ် ထုတ်လုပ်သူသည် အော့ဖ်လိုင်းပထမ ကိုယ်တိုင်လုပ်ဆောင်သော ကိရိယာ ဖြစ်သည်။",
      ...
      "privacy.choice.body": "ဘရောက်ဇာဆက်တင်မှ ကွကီးများကို ဖျက်နိုင်သည်။",
      ...
      "about.what.body": "ဘရောက်ဇာတွင် ချက်ချင်း QR ကို ထုတ်လုပ်ပေးသည်။",
      "about.offline.title": "အော့ဖ်လိုင်းတွင် အလုပ်လုပ်သည် — Service Worker Cache ဖြင့်",
      "about.offline.intro": "Haolei QR Code Generator သည် Progressive Web App (PWA) အဖြစ် တည်ဆောက်ထားသည်။",
      "about.offline.how.title": "အလုပ်လုပ်ပုံ",
      "about.offline.how.body": "Service Worker သည် နောက်ကွယ်တွင် ဖိုင်များအားလုံးကို သိမ်းဆည်းသည်။ အင်တာနက် မလိုဘဲ အသုံးပြုနိုင်သည်။",
      ...
      "about.offline.strategy.body": "စာမျက်နှာများအတွက် network-first နှင့် assets များအတွက် cache-first အသုံးပြုသည်။",
      "about.offline.benefit.title": "ဘာကြောင့် အရေးကြီးသည်",
      "about.offline.benefit.body": "Haolei QR Code Generator သည် အင်တာနက်မရှိဘဲ အသုံးပြုရန် အဆင်သင့်ဖြစ်သည်။ ထည့်သွင်းစရာ မလိုပါ။",
    ...
    mrh: {
      "app.title": "Haolei QR Code Generator",
      "app.subtitle": "Internet ta ih hneh • tracking ta ih hneh • API ta ih hneh • local hna thlâk",
      ...
      "cookies.item3": "Theme hrua",
      "cookies.item4": "Consent hrua",
      "cookies.accept": "Accept & Continue",
      "footer.cookies": "Cookies",
      "footer.privacy": "Privacy Policy",
      "footer.about": "About",
      ...
      "privacy.effective": "Effective date: February 5, 2026",
      "privacy.overview.title": "Overview",
      "privacy.overview.body": "Haolei QR Code Generator hi offline-first tool a ni.",
      "privacy.data.title": "Data kan hman",
      "privacy.data.item1": "Input content: Nang text ema URL hluh hi local ah QR a siam.",
      "privacy.data.item2": "Preferences: Size, color, format, theme hna cookies ah kan stor.",
      "privacy.cookies.title": "Cookies",
      "privacy.cookies.body": "Preferences leh consent a hrua nak a, cookies kan hman. Tracking hna kan hman lo.",
      "privacy.third.title": "Third‑Party Libraries",
      "privacy.third.body": "Site hi QRCode.js leh jsPDF a hman; CDN chungah a hman.",
      "privacy.choice.title": "Nang choice",
      "privacy.choice.body": "Browser settings ah cookies delete thei.",
      "privacy.contact.title": "Contact",
      "about.title": "Haolei QR Code Generator About",
      "about.subtitle": "Offline-first QR generation leh modern UX.",
      "about.what.title": "A hna",
      "about.what.body": "Browser ah chak tawh QR siam.",
      "about.offline.title": "Offline ah Hman Thei — Service Worker Cache ih",
      "about.offline.intro": "Haolei QR Code Generator hi Progressive Web App (PWA) a ni tawh offline ah hman thei.",
      "about.offline.how.title": "A hna dan",
      "about.offline.how.body": "App ka load hmasa bik ah, Service Worker hi background ah install a ni tawh file hna cache a ni. Tlawh khat hnuah, app pumpi hi browser cache ah a awm tawh — internet connection a ngai lo.",
      "about.offline.what.title": "Cache a ni hna",
      "about.offline.item1": "Pages hna: Generator, About, leh Privacy",
      "about.offline.item2": "Stylesheets leh scripts hna",
      "about.offline.item3": "Translation files hna (English, Mara, Burmese)",
      "about.offline.item4": "App logo leh icon",
      "about.offline.strategy.title": "Cache strategy",
      "about.offline.strategy.body": "App hi page hna ah network-first leh assets hna ah cache-first strategy a hman.",
      "about.offline.benefit.title": "A pawimawh nah",
      "about.offline.benefit.body": "Vanleng chungah, signal awm loh hmun ah pawh, Haolei QR Code Generator hi hman thei. Install a ngai lo — tlawh khat mai.",
      "about.why.title": "A pawimawh",
      "about.why.body": "Data hi device chungah a awm; tracking lo.",
      "about.open.title": "Open source",
      "about.open.body": "MIT license a ni; custom thei.",
      "about.contact.title": "Contact",
      "language.label": "Language"
    }
  };
